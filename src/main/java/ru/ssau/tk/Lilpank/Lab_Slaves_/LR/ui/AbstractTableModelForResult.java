...
public class AbstractTableModelForResult extends AbstractTableModel {
    private static final int INDEX_COLUMN_NUMBER = 0;
    private static final int X_COLUMN = 1;
    private static final int Y_COLUMN = 2;
    private static final long serialVersionUID = -8351350684642922903L;
    private TabulatedFunction function;

    public AbstractTableModelForResult() {
    }
